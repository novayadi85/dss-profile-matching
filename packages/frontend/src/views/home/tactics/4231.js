                ...
                <div className="pitch-container">
                    <div className="pitch">
                        <div className="home">
                            ...
                            <ul className="player" style={{ top: 'calc(20% - 16px)', left: '29.0909090909091%' }} title="" data-playerid={141087}>
                                <li className="player-name-wrapper">
                            ...
                            <ul className="player" style={{ top: 'calc(80% - 16px)', left: '29.0909090909091%' }} title="" data-playerid={137533}>
                                <li className="player-name-wrapper">

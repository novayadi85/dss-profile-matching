                ...
                <div className="pitch-container">
                    <div className="pitch">
                        <div className="home">
                            ...
                            <ul className="player" style={{ top: 'calc(35% - 16px)', left: '20%' }} title="" data-playerid={433488}>
                                <li className="player-name-wrapper">
                            ...
                            <ul className="player" style={{ top: 'calc(65% - 16px)', left: '20%' }} title="" data-playerid={126871}>
                                <li className="player-name-wrapper">
                            ...
                            <ul className="player" style={{ top: 'calc(20% - 16px)', left: '38.181818181818%' }} title="" data-playerid={141087}>
                                <li className="player-name-wrapper">
                            ...
                            <ul className="player" style={{ top: 'calc(80% - 16px)', left: '38.181818181818%' }} title="" data-playerid={137533}>
                                <li className="player-name-wrapper">
                            ...
                            <ul className="player" style={{ top: 'calc(50% - 16px)', left: '38.1818181818182%' }} title="" data-playerid={311339}>
                                <li className="player-name-wrapper">
